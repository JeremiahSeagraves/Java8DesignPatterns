...
/**
 * This client uses different adapters to store multiple employees into the same List adapting all the other new employees
 * using their specific adapters to return an employee instance
 */
